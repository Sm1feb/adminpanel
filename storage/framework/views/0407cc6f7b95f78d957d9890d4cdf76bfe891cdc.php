	...
	<aside>
		...
		<div class="col-md-10 main-section">
			<section>
				...
				<p class="bordered text-center" style="padding:3px"><a href="#" style="text-decoration:underline; color:blue; font-size:12px">Click here</a>
					...
					<form action="<?php echo e(url('/searchr')); ?>" method="post">	
		...
		<table class="table2">
			...
			<td><?php echo e($row->id); ?></td>
                ...
                <td><a href="<?php echo e('edit4/'.$row->id); ?>">Edit</a></td>
				<td><a href="<?php echo e('delete1/'.$row->id); ?>">delete</a></td>
</tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<tr>
	<td colspan="4"><?php echo e($date->links()); ?></td>
</tr>
</table>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\mysecondproject\resources\views/csummary.blade.php ENDPATH**/ ?>