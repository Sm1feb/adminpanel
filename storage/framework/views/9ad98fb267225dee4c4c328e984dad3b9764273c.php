				...
				<?php echo e(csrf_field()); ?>
					...
					<table class="addpage-table">
						...
						<tr>
							...
							<td>
								<input type="text" name="content" class="tinymce" style="height:150px" value="<?php echo e(isset($findrec[0]->content) ? $findrec[0]->content:""); ?>">
						...
						<tr>
							...
							<td>
								<input type="checkbox" name="status" style="width:50px; margin-right:20px" value="<?php echo e(isset($findrec[0]->status) ? $findrec[0]->status:""); ?>">
							</td>
						</tr>
						<tr>
							<td colspan="2" >
...
<?php /**PATH C:\xampp\htdocs\mysecondproject\resources\views/addpage.blade.php ENDPATH**/ ?>