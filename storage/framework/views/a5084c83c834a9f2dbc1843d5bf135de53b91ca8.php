	...
	<aside>
		...
		<div class="col-md-10 main-section">
			<section>
                ...
                <form action="<?php echo e(url('p_editdata/'.$findrec[0]->id)); ?>" method="post">
            <?php else: ?>
            <?php endif; ?>
				<form action="<?php echo e(url('categoryname')); ?>" method="post">
				<?php echo e(csrf_field()); ?>
					...
					<table class="addpage-table">
						...
						<tr>
							...
							<td>
								<input type="text" name="catname" style="width:200px" value="<?php echo e(isset($findrec[0]->categoryname) ? $findrec[0]->categoryname:""); ?>">
							</td>
						</tr>
...
<?php /**PATH C:\xampp\htdocs\mysecondproject\resources\views/addcategory.blade.php ENDPATH**/ ?>